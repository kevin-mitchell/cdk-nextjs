...
export interface NextjsDomainCProps extends NextjsBaseProps {
  /**
...
export class NextjsDomain extends Construct {
  protected props: NextjsDomainCProps;
  ...
  constructor(scope: Construct, id: string, props: NextjsDomainCProps) {
    super(scope, id);
