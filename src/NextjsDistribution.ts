...
export interface NextjsDistributionProps extends NextjsBaseProps {
  ...
  /**
   * Optional ACM certificates - if a certificate is supplied at least one matching domain msut
   * also be supplied.
   *
   * See: https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_cloudfront.Distribution.html#domainnames
   */
...
export class NextjsDistribution extends Construct {
  ...
  private createCloudFrontDistribution(cfDistributionProps?: NextjsDistributionCdkOverrideProps) {
    return new cloudfront.Distribution(this, 'Distribution', {
      ...
      // TODO: this should be passed into the construct probably
